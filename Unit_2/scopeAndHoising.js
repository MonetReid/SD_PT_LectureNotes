...
checkGlobalVariable(); // GLOBAL SCOPE
...
// console.log(` In the newScope function: ${z}`); // Z is not defined, local variable to the function only
...
varTest();
console.log(`Var - function/globally: ${a}`);
...
/* 
Let - start of function 100
Let - within if: 50
Let - end of function: 100
Let - Outside Function/Global value: 12
*/
...
//newFunc();// arrow functions cannot be accessed before initialization.
let newFunc = () => { 
    console.log("Hoisted?");
}
