...
//  Null: is a value of "nothing", something that doesn't exist. An intentional absence of any object value. (kind of like putting n/a on a form)
let empty = null;
console.log(empty);
...
2. Objects are denoted/indicates by the curly braces {}, inside the brackets are the objects properties.
...
// use parenthesis to call a method... hence two sets of parenthesis above that is pink... (.) period is used to indicate a method is being called upon.
