...
hello(); // Expression variable name is required to run function
 ...
 console.log(hello); // Will return that hello is a function but will not invoke a function.
...
greet("Ben"); // name = Ben "Hey there, Ben"
greet("Kate");// name = Kate "Hey there, Kate"
greet("Tiny"); // name = Tiny "Hey there, Tiny"
